...
3. Clients who are certain that they have no IPv6 connectivity SHOULD treat this Service Endpoint as not "compatible" ({{SVCB}} Section 8) and not include it in their candidate list.
